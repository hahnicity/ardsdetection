...
def main():
    ...
    parser.add_argument('-fsm', '--feature-selection-method', choices=['RFE', 'chi2', 'mutual_info', 'gini', 'lasso'], help='Feature selection method', required=True)
    ...
    if main_args.feature_selection_method == 'RFE':
        results = regressive(df, model_args)
